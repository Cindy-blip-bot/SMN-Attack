...
from SMN_Attack import Attacker, ImageAttacker, TextAttacker
...
def retrieval_eval(model, ref_model, t_models, t_ref_models, t_test_transforms, data_loader, tokenizer, t_tokenizers, device, args,config):
    ...
    save_path = os.path.join(save_dir, "adv_texts.jsonl")
    with open(save_path, "w", encoding="utf-8") as f:
        f.write("")

    images_normalize = transforms.Normalize((0.48145466, 0.4578275, 0.40821073), (0.26862954, 0.26130258, 0.27577711))
    img_attacker = ImageAttacker(images_normalize,  steps=10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tcl_ckpt', default='./checkpoints/tcl_coco.pth', type=str)    
